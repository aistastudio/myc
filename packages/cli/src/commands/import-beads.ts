 ...
 * В конце для гарантии зовётся recountOpenBlockers, и только если счётчики
 * реально разошлись (openBlockersDrift непуст).
 *
...
export function importBeadsSnapshot(
  ...
  if (!dry && h.store.openBlockersDrift().length > 0) {
