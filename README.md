...
```bash
bun install -g @aistastudio/myc   # 3.42 MB compressed, 12.60 MB unpacked, 13 files; no models pulled
myc --version                     # myc 0.3.10 (schema 1)
```
...
is treated as absent. The full suite: 3727 pass / 0 fail / 16 skip
(`bun test`, 2026-09-11).
